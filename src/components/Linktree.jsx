      ...
      <section>
        ...
        <nav>
          <ul>
            <li>
              <a
                className="lojas"
                href="https://wa.me/5581987901785"
                target="_blank"
              >
            ...
            <li>
              <a
                className="lojas"
                href="https://wa.me/5581987918380"
                target="_blank"
              >
                <img className="whats" src="./whats.png" alt="Whats" />
                <p>Loja Escada</p>
            ...
            <li>
              <a
                className="lojas"
                href="https://wa.me/5581985348454"
                target="_blank"
              >
                <img className="whats" src="./whats.png" alt="Whats" />
                <p>Loja Palmares</p>
            ...
            <li>
              <a
                className="lojas"
                href="https://wa.me/5581986950572"
                target="_blank"
              >
                <img className="whats" src="./whats.png" alt="Whats" />
        ...
        <div className="containerInsta">
          <a
            ...
            href="https://www.instagram.com/fashion.dayi/"
            target="_blank"
          >
